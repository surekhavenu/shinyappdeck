...
```{r echo =FALSE}
tabs <- c("Enroll Student Details" , "Help")
cat(tabs, sep = "\n")
```

2. `r tabs[1]` Tab allows to enter student name, sex and 
   data science specialization courses completed. 
   
3. `r tabs[1]` Tab calculates the number of courses 
...
4. `r tabs[2]` Tab provides the information required to use the application.
